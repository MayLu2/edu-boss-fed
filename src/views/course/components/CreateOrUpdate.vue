  ...
  <el-card>
    <div slot="header">
      <el-steps :active="activeStep" simple >
        ...
        :key="index" @click.native="activeStep=index"
        :title="item.title" :icon="item.icon"></el-step>
      </el-steps>
    </div>
      ...
      <div v-show="activeStep===1">
        <el-form-item label="课程封面">
          ...
          <!-- <el-upload
            ...
            <img v-if="imageUrl" :src="course.courseListImg" class="avatar">
      ...
      <div v-show="activeStep===2">
        ...
        <el-form-item label="商品原价">
           <el-input v-model.number="course.price" type="number">
              <template slot="append" type="number">元</template>
            </el-input>
        </el-form-item>
        <el-form-item label="销量">
           <el-input v-model.number="course.sales" type="number">
              <template slot="append" type="number">单</template>
            </el-input>
        </el-form-item>
      ...
      <div v-show="activeStep===3">
       ...
       <div v-show="activeStep===4">
        <el-form-item label="课程详情">
          <!-- 富文本编辑器,以下是扩展性和编辑型比较好
          1.ckeditor
          2.quilljs/quill
          3. yabwe/medium-editor
          4.wangeditor-team/wangEditor
          5.fex-team/ueditor--百度
          6.tinymce/tinymnce
          -->
  ...
  methods: {
    ...
    async loadCourse () {
      ...
      if (activityCourseDTO) {
        activityCourseDTO.beginTime = moment(activityCourseDTO.beginTime).format('YYYY-MM-DD HH:mm:ss')
        activityCourseDTO.endTime = moment(activityCourseDTO.endTime).format('YYYY-MM-DD HH:mm:ss')
      }
